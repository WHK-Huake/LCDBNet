...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default=r'G:\low-light_image_enhancement\Our\dataset\LOL\eval15\high', type=str)
    #LOL G:\low-light_image_enhancement\Our\dataset\LOL\eval15\high
    #MIT G:\low-light_image_enhancement\dataset\MIT\GT
    parser.add_argument('-dirB', default=r'G:\low-light_image_enhancement\Lowlight_YCbCr\results\LCDBNet\wo_FN\wo_fn', type=str)
